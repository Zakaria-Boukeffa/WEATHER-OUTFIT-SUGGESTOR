...
export default function Home() {
  ...
  const predefinedCities = ["Toulouse", "Paris", "Venice", "Alger", "Jijel"];
  ...
  const handleContinue = () => {
    ...
    if (!cityToSend) return alert("Choisis une ville !");
  ...
  return (
    ...
    <h1 style={{
      ...
      >
        ...
        <option value="after">Après-demain</option>
      </select>
